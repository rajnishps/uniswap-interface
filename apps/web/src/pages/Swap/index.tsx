...
export function Swap({
  ...
  const prefilledState = useSwapPrefilledState({
    ...
    selectingCurrencyField: isSwapTokenSelectorOpen
      ? CurrencyField.OUTPUT
      : undefined,
    selectingCurrencyChainId: swapOutputChainId,
    skipFocusOnCurrencyField: isMobileWeb,
    filteredChainIdsOverride: usePersistedFilteredChainIds
          ...
          <PrefetchBalancesWrapper>
            ...
            >
              <Flex
                position="relative"
                gap="$spacing16"
                opacity={isSharedSwapDisabled ? 0.6 : 1}
              >
...
function UniversalSwapFlow({
  ...
  const SWAP_TAB_OPTIONS: readonly SegmentedControlOption<SwapTab>[] =
    useMemo(() => {
