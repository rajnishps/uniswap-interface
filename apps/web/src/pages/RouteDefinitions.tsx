...
const CreatePosition = lazy(
  () => import("pages/CreatePosition/CreatePosition")
);
const AddLiquidityV3WithTokenRedirects = lazy(
  () => import("pages/AddLiquidityV3/redirects")
);
...
const ExtensionPasskeyAuthPopUp = lazy(
  () => import("pages/ExtensionPasskeyAuthPopUp")
);
const PasskeyManagement = lazy(() => import("pages/PasskeyManagement"));
const ExtensionUninstall = lazy(
  () => import("pages/ExtensionUninstall/ExtensionUninstall")
);
...
const StaticTitlesAndDescriptions = {
  ...
  AirdropDescription: "Airdrop",
  LaunchpadTitle: "Launchpad",
  LaunchpadDescription: "Launchpad",
};
...
export const routes: RouteDefinition[] = [
  ...
  createRouteDefinition({
    ...
    getTitle: () => StaticTitlesAndDescriptions.LaunchpadTitle,
    getDescription: () => StaticTitlesAndDescriptions.LaunchpadDescription,
  }),
