...
import {
  FormStepsWrapper,
  FormWrapper,
} from "components/Liquidity/Create/FormWrapper";
...
const Toolbar = () => {
  ...
  const customSlippageTolerance = useTransactionSettingsStore(
    (s) => s.customSlippageTolerance
  );
