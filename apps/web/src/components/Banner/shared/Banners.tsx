...
import {
  SOLANA_PROMO_BANNER_STORAGE_KEY,
  SolanaPromoBanner,
} from "components/Banner/SolanaPromo/SolanaPromoBanner";
...
export function Banners() {
  ...
  const isLPIncentivesEnabled = false;
  ...
  const pageChainId = useMemo(() => {
    ...
    return chainUrlParam
      ? getChainIdFromChainUrlParam(chainUrlParam)
  ...
  const userAlreadySeenSolanaPromo =
    localStorage.getItem(SOLANA_PROMO_BANNER_STORAGE_KEY) === "true";
